      ...
      <script>
         function kakaoLogout(kakaokey){
            ...
            Kakao.Auth.logout(function(){
               ...
               location.href="https://kauth.kakao.com/oauth/logout?client_id=0edd445183046db92bac4fa540f7da2b&logout_redirect_uri=http://localhost:8081/travel/apiLogout";
            })
         }
</script>
       <!-- The Modal -->
...
<script type="text/javascript">
  Kakao.init('0edd445183046db92bac4fa540f7da2b');
