	...
	<main>
		...
		<div
			...
			<c:if test="${type2==null }">
				<a class="pagenum" href="?pcategory=${type1 }&page=1">&lt;&lt;</a>
				<!--(1) 첫번째 페이지 1번으로 이동 -->
				...
				<a class="pagenum"
					href="?pcategory=${type1 }&page=${paging.totalPage }">&gt;&gt;</a>
				<!--(5) 가장 마지막 페이지로 이동 -->
			</c:if>

			<c:if test="${type2 != null}">
				<a class="pagenum"
					href="?pcategory=${type1 }&address=${type2 }&subaddress=${type3}&page=1">&lt;&lt;</a>
				<a class="pagenum"
				...
				<a class="pagenum"
					...
					style='<c:if test="${paging.endPage==paging.totalPage }">display:none;</c:if>'>&gt;</a>
				<a class="pagenum"
					href="?pcategory=${type1 }&address=${type2 }&subaddress=${type3}&page=${paging.totalPage }">&gt;&gt;</a>
				<!--(5) 가장 마지막 페이지로 이동 -->
			</c:if>
		</div>
	</main>
